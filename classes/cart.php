...
<?php
        ...
        class cart
        {
            ...
            public function add_to_cart($getsize, $quantity, $id){
                ...
                // }else{
                    ...
                    $query_insert = "INSERT INTO tbl_cart(productId,quantity,sId,image,price,productName,getsize) VALUES('$id','$quantity','$sId','$image','$price','$productName','$getsize')";
